inherited frmMDFEnfeCADASTROunidTRANSPORTEcadastro: TfrmMDFEnfeCADASTROunidTRANSPORTEcadastro
  ...
  inherited pageDefault: TJvPageControl
    ...
    inherited tabDefault: TTabSheet
      ...
      object JvgGroupBox15: TJvgGroupBox
        ...
        Height = 563
        Align = alClient
        Caption = 'NF-e - Unidades de Transporte'
        TabOrder = 0
        ...
        object JvgGroupBox12: TJvgGroupBox
          ...
          object JvDBGrid2: TJvDBGrid
            ...
            Height = 150
            Align = alBottom
            DataSource = dtstabMDFE_NFE_UNIDTRANS_LACRE
        ...
        object JvgGroupBox1: TJvgGroupBox
          ...
          Width = 677
          Height = 242
          Caption = 'NF-e - Unidades de Carga'
          TabOrder = 4
          Border.Inner = bvSpace
          Border.Outer = bvNone
          Border.Bold = False
          ...
          object JvDBGrid1: TJvDBGrid
            ...
            Height = 174
            Align = alBottom
            DataSource = dtstabMDFE_NFE_CARGTRANS
            Options = [dgEditing, dgTitles, dgIndicator, dgColumnResize, dgColLines, dgRowLines, dgTabs, dgConfirmDelete, dgCancelOnExit, dgMultiSelect, dgTitleClick, dgTitleHotTrack]
            ReadOnly = True
            TabOrder = 1
            TitleFont.Charset = DEFAULT_CHARSET
  ...
  inherited dtsDefault: TDataSource
    DataSet = dtmMDFE.qryMDFE_NFE_UNIDTRANS
    Left = 158
    Top = 179
  end
  object dtstabMDFE_NFE_UNIDTRANS_LACRE: TDataSource
    DataSet = dtmMDFE.tabMDFE_NFE_UNIDTRANS_LACRE
    OnDataChange = dtstabMDFE_NFE_UNIDTRANS_LACREDataChange
    Left = 558
    Top = 155
  end
  object dtstabMDFE_NFE_CARGTRANS: TDataSource
    DataSet = dtmMDFE.tabMDFE_NFE_CARGTRANS
    OnDataChange = dtstabMDFE_NFE_UNIDTRANS_LACREDataChange
    Left = 502
    Top = 435
  end
