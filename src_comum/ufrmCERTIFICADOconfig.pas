...
begin
  ...
  case FDocModelo of
    mCTe: TFDQuery(dtsDefault.DataSet).ParamByName('ID_MODELO').AsInteger := 57;
    mCTeOS: TFDQuery(dtsDefault.DataSet).ParamByName('ID_MODELO').AsInteger := 67;
    mMDFe :TFDQuery(dtsDefault.DataSet).ParamByName('ID_MODELO').AsInteger := 58;
    mNFe :TFDQuery(dtsDefault.DataSet).ParamByName('ID_MODELO').AsInteger := 55;
  end;
  ...
  begin
    ...
    case FDocModelo of
      ...
      mCTeOS: TFDQuery(dtsDefault.DataSet).FieldByName('ID_MODELO').AsInteger := 67;
      mMDFe: TFDQuery(dtsDefault.DataSet).FieldByName('ID_MODELO').AsInteger := 58;
      mNFe: TFDQuery(dtsDefault.DataSet).FieldByName('ID_MODELO').AsInteger := 55;
    end;
  end
  else
