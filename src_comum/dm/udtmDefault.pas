...
uses
  ...
  Data.DB, FireDAC.Comp.Client, Vcl.Forms, FireDAC.Phys.FB,
...
type
  TdtmDefault = class(TDataModule)
    ...
    tabPESSOASCBR_VALOR: TFMTBCDField;
    tabEMPRESACTE_NUMERO_INICIAL: TIntegerField;
    tabEMPRESAMDFE_NUMERO_INICIAL: TIntegerField;
    QryGen: TFDQuery;
    tabMOTORISTAS: TFDQuery;
    tabVEICULOS: TFDQuery;
    tabMOTORISTASID_EMPRESA: TIntegerField;
    tabMOTORISTASID_MOTORISTA: TIntegerField;
    tabMOTORISTASNOME: TStringField;
    tabMOTORISTASCPF: TStringField;
    tabVEICULOSID_EMPRESA: TIntegerField;
    tabVEICULOSID_VEICULO: TIntegerField;
    tabVEICULOSRNTRC: TStringField;
    tabVEICULOSCOD_AGENDA_PORT: TStringField;
    tabVEICULOSCODIGO_INTERNO: TStringField;
    tabVEICULOSTIPO_CARROCERIA: TIntegerField;
    tabVEICULOSPLACA: TStringField;
    tabVEICULOSUF: TStringField;
    tabVEICULOSRENAVAN: TStringField;
    tabVEICULOSTIPO_RODADO: TIntegerField;
    tabVEICULOSCAPACIDADE_KG: TFMTBCDField;
    tabVEICULOSCAPACIDADE_M3: TFMTBCDField;
    tabVEICULOSDESCRICAO: TStringField;
    tabVEICULOSTIPO_VEICULO: TIntegerField;
    tabVEICULOSTARA: TFMTBCDField;
    tabVEICULOSCOR: TStringField;
    tabVEICULOSCOR_DESCRICAO: TStringField;
    tabVEICULOSCODIGO_MARCA_MODELO: TStringField;
    tabVEICULOSVALOR_UNITARIO: TFMTBCDField;
    tabVEICULOSFRETE_UNITARIO: TFMTBCDField;
    tabVEICULOSCHASSI: TStringField;
    tabUSUARIO: TFDQuery;
    tabUSUARIOID_USUARIO: TIntegerField;
    tabUSUARIOUSUARIO: TStringField;
    tabUSUARIOSENHA: TStringField;
    tabUSUARIODATAHORA: TSQLTimeStampField;
    cnx_BDSiscom: TFDConnection;
    SqlConsultaNFe: TFDQuery;
    SqlConsultaNFeNFNUMERO: TIntegerField;
    SqlConsultaNFeDATAMOV: TDateField;
    SqlConsultaNFeSERIE: TStringField;
    SqlConsultaNFeTOTALGERAL: TFMTBCDField;
    SqlConsultaNFeCHAVE_ACESSO: TStringField;
    SqlConsultaNFePESO_BRUTO: TFMTBCDField;
    ...
    tabCERTIFICADO_CONFIGAJUSTE_AUTOMATICO_AGUARDAR: TBooleanField;
    tabCERTIFICADO_CONFIGAGUARDAR_SEGUNDOS: TIntegerField;
    tabCERTIFICADO_CONFIGTENTATIVAS: TSmallintField;
    tabCERTIFICADO_CONFIGINTERVALO_SEGUNDOS: TIntegerField;
    tabCERTIFICADO_CONFIGCAMINHO_CERTIFICADO: TStringField;
    tabCERTIFICADO_CONFIGSENHA_CERTIFICADO: TStringField;
    tabCERTIFICADO_CONFIGASSINAR: TBooleanField;
    tabCERTIFICADO_CONFIGFORMA_EMISSAO_INDEX: TSmallintField;
    tabCERTIFICADO_CONFIGINTEGRADORA_INDEX: TSmallintField;
    tabCERTIFICADO_CONFIGGERAL_USUARIO: TStringField;
    tabCERTIFICADO_CONFIGGERAL_SENHA: TStringField;
    tabCERTIFICADO_CONFIGGERAL_HASH_INTEGRADOR: TStringField;
    tabCERTIFICADO_CONFIGSSL_LIB_INDEX: TSmallintField;
    ...
    procedure tabMOTORISTASBeforeOpen(DataSet: TDataSet);
    procedure tabMOTORISTASBeforePost(DataSet: TDataSet);
    procedure tabMOTORISTASNewRecord(DataSet: TDataSet);
    procedure tabVEICULOSBeforeOpen(DataSet: TDataSet);
    procedure tabVEICULOSBeforePost(DataSet: TDataSet);
    procedure tabVEICULOSNewRecord(DataSet: TDataSet);
    procedure tabUSUARIOBeforePost(DataSet: TDataSet);
    procedure cnx_BDSiscomBeforeConnect(Sender: TObject);
    procedure SqlConsultaNFeBeforeOpen(DataSet: TDataSet);
  published
    procedure TFieldSetOnlyNumber(Sender: TField; const Text: string);
  private
    procedure configurarCNX;
    procedure configurarCNXSiscom;
...
{ TdmCTeOS }
function TdtmDefault.ChecaExisteGen(Nome: String): Boolean;
begin
  QryGen.Close;
  QryGen.Sql.Clear;
...
procedure TdtmDefault.cnx_BDSiscomBeforeConnect(Sender: TObject);
begin
  configurarCNXSiscom;
end;
...
function TdtmDefault.CriarGen(Nome: String): Boolean;
begin
  QryGen.Close;
  QryGen.Sql.Clear;
...
function TdtmDefault.IncGen(Generator: string): Integer;
begin
  QryGen.Close;
  QryGen.Sql.Clear;
...
function TdtmDefault.RetornaGen(Nome: String): Integer;
begin
  QryGen.Close;
  QryGen.Sql.Clear;
...
procedure TdtmDefault.SqlConsultaNFeBeforeOpen(DataSet: TDataSet);
begin
  TFDQuery(DataSet).ParamByName('ID_EMPRESA').AsInteger := oEmpresa.ID;
end;
