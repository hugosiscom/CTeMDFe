...
uses
  ...
  ACBrEnterTab, JvExControls, JvSpeedButton, Vcl.ExtCtrls, FireDAC.Stan.Intf,
  FireDAC.Stan.Option, FireDAC.Stan.Param, FireDAC.Stan.Error, FireDAC.DatS,
  FireDAC.Phys.Intf, FireDAC.DApt.Intf, FireDAC.Stan.Async, FireDAC.DApt,
  Data.DB, FireDAC.Comp.DataSet, FireDAC.Comp.Client, JvMaskEdit, JvDBControls,
  Vcl.StdCtrls, Vcl.Mask, JvExMask, JvToolEdit, JvExExtCtrls,
  JvImage, FireDAC.Stan.Def, FireDAC.VCLUI.Wait, FireDAC.Phys.IBWrapper,
  FireDAC.Phys, FireDAC.Phys.IBBase, Vcl.ComCtrls, JvExComCtrls,
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        ...
        begin
          raise EFilerError.Create(
            'Erro ao excluir o arquivo zip já existente:' + sLineBreak +
      ...
      dtmDefault.cnx_BD.ExecSQL(
        Format(
          'UPDATE OR INSERT INTO CONTROLE (ID_CONTROLE, BACKUP_DATA ) '#13+
          '                        VALUES (1, CURRENT_TIMESTAMP     ) '#13+
          '                      MATCHING (ID_CONTROLE);              ',
          [1,QuotedStr('Admin')]
        )
      );
    ...
    begin
      Application.MessageBox(
        PChar('Ocorreu erro ao efetuar o Backup' +#13 +e.Message),
        'Backup',
        MB_ICONWARNING
      );
